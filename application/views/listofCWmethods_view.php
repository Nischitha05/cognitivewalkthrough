...
<!-- <nav class="navbar navbar-default navbar-static-top"> -->
  <div class="container-fluid">
    ...
    <div class="container"  style="margin-top:20px;">
        ...
        <h3>Please choose the task to perform Cognitive Walkthrough</h3>
...
<?php foreach ($variant as $row) {
  ?>
  <li class="form-group">
    <?php if($row->variantid =='6'){
      ?>
    <a title="Perform MCW without any questions">None(without questions)</a>
<?php } else{
?>
  <a href="<?php echo site_url('variants/getvariantpage/').$row->variantid; ?>"><?php echo $row->variantname ?></a> | <a style="color:red" href="<?php echo site_url('variants/deletevariant/').$row->variantid; ?>">Delete</a>
<?php
} ?>
  </li>
  <?php
