...
<!-- <nav class="navbar navbar-default navbar-static-top"> -->
  <div class="container-fluid">
    ...
    <div class="container"  >
      <a href="<?php echo site_url('variants/viewvariantfromoverview/').$taskid.'/'.$personaid; ?>"><input type="button" class='btn btn-lg btn-danger' value="Go back" /></a>

      <?php //foreach ($result as $row) {
        # code...
      ?>
      <!-- <a href="<?php// echo site_url('variants/gotomethodview/').$row->timest.'/'.$row->taskid.'/'.$row->personaid.'/'.$row->variantid; ?>"><input type="button" class='btn btn-lg btn-danger' value="Get other alternatives" /></a>
      <a href="<?php //echo site_url('variants/getoverview/').$row->taskid.'/'.$row->timest; ?>"><input type="button" class='btn btn-lg btn-success' value="Task Overview" /></a> -->
...
<div class="tree">
    ...
    $taskid = $row->taskid;
     ?>
     <li>
    <a href="#"><?php echo $row->taskname?></a>
    <ul>
