...
-->
              <?php
              echo form_open('variants/cwperform','class="myclass"');
              ?>

              <a href="<?php echo site_url('variants/getoverview/').$taskid.'/'.$timestamp; ?>"><input type="button" class='btn btn-lg btn-success' value="Task Overview" /></a>
...
<input type="hidden" name="personaid" id="personaid" value="<?php echo $row->personaid; ?>"/><br>
...
<div>
  ...
  <img id="startimage" style="float: left;
                            ...
                            width: 450px;
                            height: 250px; "
                            src="http://localhost/cognitivewalkthrough/uploads/<?php echo $row->Startimage ?>"></div><br>
  ...
  <h4>Variants:</h4>
              ...
              {?>
                  ...
                  <input type="radio" checked="true" name="variants" id="variants" value="<?php echo $row->variantid ?>"/><p><?php echo $row->variantname ?></p>
