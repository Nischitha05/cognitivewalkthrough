...
<!-- <nav class="navbar navbar-default navbar-static-top"> -->
  <div class="container-fluid">
    ...
    <div class="container"  >
          ...
          <h3 style="color:blue">Starting of Cognitive Walkthrough</h3>
 <!-- <div class="jumbotron"> -->
...
<!-- <form method='post' id="theform"> -->
              ...
              <input type='hidden' value='<?php echo $timestamp ?>' name='timestamp' id='timestamp'/>               <!-- <div class="form-group">
...
<div>
  ...
  {?>
   <h4>Task Name:</h4>
                        <p><?php echo $row3->taskname; ?></p>
                        <input type="hidden" name="taskid" id="taskid" value="<?php echo $row3->taskid; ?>"/><br>
                          <input type="hidden" name="taskname" id="taskname" value="<?php echo $row3->taskname; ?>"/><br>
...
$(document).ready(function(){
  ...
  $(document).on("click", '#save', function(e) {
    ...
    $.ajax({
         type: 'POST',
        url: "<?= base_url() ?>index.php/variants/performdatafirststepfromnone/",
         data:$('form').serialize(),
  ...
  //     console.log(chosen_altmethod,'chosen_altmethod');
    ...
    formData.append('variantid',variantid);
       ...
       formData.append('home',home);
           ...
           $.ajax({
                type: 'POST',
           url: "<?= base_url() ?>index.php/variants/getnextstepimage/",
            data: formData,
           processData: false,
       contentType: false,
