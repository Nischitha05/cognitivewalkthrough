...
<!-- <nav class="navbar navbar-default navbar-static-top"> -->
  <div class="container-fluid">
    ...
    <div class="container"  style="margin-top:20px;">
      ...
      <!-- <div class="jumbotron"> -->
        <h3>Please send email to invite experts or evaluators to perform Cognitive Walkthrough</h3>
        ...
        <div class="span6 offset3">
         <?php
            ...
            <h4> Task:</h4>  <select class="form-control" name="taskname" id="taskname" required>
   <option value="">Select</option>
           ...
           <div class="form-group">
            <h4>Persona:</h4>  <select class="form-control" name="personadrop" id="personadrop" required>
              <option value="">Select</option>

            </select>
            </div>
            <div class="form-group">
          <h4> Variant:</h4>  <select class="form-control" name="variantname" id="variantname" required>
          <option value="">Select</option>

             <?php foreach($variants as $row){
          echo '<option value="' . $row->variantid . '">' . $row->variantname . '</option>';
   ...
   <div class="form-group">
    ...
    //           echo form_error('description','<div class="error_msg">','</div>');
                 ...
                 echo form_textarea('message',set_value('message'),'class="form-control" id="message" placeholder="Enter message. Note: The link to the registration page will be added automatically. "')
               ?>
</div>
                   <input class ="btn btn-primary btn-lg" type = "submit" value = "SEND MAIL">
