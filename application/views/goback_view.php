...
<!-- <nav class="navbar navbar-default navbar-static-top"> -->
  <div class="container-fluid">
    ...
    <div class="container"  >
      <h3 style="color:blue">View the list of the created alternatives<p style="color:grey" title="Kindly select one of the alternatives to add the action sequence for that alternative">(i)</p></h3>
 <!-- <div class="jumbotron"> -->
...
-->
              ...
              <!-- <form action="task/methodview/" method="post" enctype="multipart/form-data" id="upload-form"> -->
...
foreach($records as $row1) {
     ...
     ?>
                      <input type="text" name="taskname" value="<?php echo $row1->taskname;?>" class="form-control" readonly/>
                        <input type="hidden" name="taskid" value="<?php echo $row1->taskid;?>" class="form-control" readonly/>
