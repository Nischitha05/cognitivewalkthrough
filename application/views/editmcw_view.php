...
<!-- <nav class="navbar navbar-default navbar-static-top"> -->
  <div class="container-fluid">
    ...
    <div class="container"  style="margin-top:20px;">
      ...
      <!-- <div class="jumbotron"> -->
        <h3>Please choose a task to delete Multiway Cognitive Walkthrough </h3>
         <?php
              ...
              <tr>
                ...
                <tbody>
                  ...
                  foreach($groups as $row)
                  {
                      ...
                      <td><a href="<?php echo site_url('variants/getoverviewfromedittask/').$row->taskid; ?>">Overview</a>|<a href="<?php echo site_url('task/editselectedtask/').$row->taskid; ?>">Edit</a>|<a href="<?php echo site_url('task/deletetask/').$row->taskid; ?>"><span class="glyphicon glyphicon-trash">Delete</span></a></td>
